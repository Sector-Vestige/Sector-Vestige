cd-create-map-patch-verb = Add to patchset
cd-create-map-patch-verb-desc =
    Add to the current patch set, which can be printed with `cd_map_patch:print` or `cd_map_patch:write` in the console.
